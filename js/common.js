const apikey = "5e89d1d6bb94b26a26916e92e3c769ed";
const pages = 10
...
const searchmovie = async () => {
    try {
        ...
        for (let index = 1; index <= pages; ++index) {
            console.log(`https://api.themoviedb.org/3/search/multi?api_key=5e89d1d6bb94b26a26916e92e3c769ed&query=${keyword}&page=${index}`);
            const api = await axios.get(`https://api.themoviedb.org/3/search/multi?api_key=5e89d1d6bb94b26a26916e92e3c769ed&query=${keyword}&page=${index}`)
